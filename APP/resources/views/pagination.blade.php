@if ($paginator->hasPages())
    ...
    <div class="mt-4">
        <div class="d-flex p-0 dataTables_paginate paging_simple_numbers">
            <div class="col-xs-6 col-lg-4 col-md-6 col-sm-6 col-xs-6 table-responsive">
            ...
            <div class="col-xs-6 col-lg-8 col-md-6 col-sm-6 col-xs-6 table-responsive">
                <span class="pagination-pages">
                    <ul class="pagination" role="navigation" id="paginatorBtn">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" id="1"
                                    href="{{ $paginator->toArray()['first_page_url'] }}">{{ trans('pagination.first') }}</a>
                            </li>
                        @endif
                        {{-- Previous Page Link --}}
                        @if ($paginator->onFirstPage())
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" id="{!! $previousPage !!}"
                                    href="{{ $paginator->previousPageUrl() }}">{{ trans('pagination.previous') }}</a>
                            </li>
                        @endif
                        {{-- Pagination Elements --}}
                        ...
                        @if ($paginator->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" id="{!! $nextPage !!}"
                                    ...
                                    rel="next">{{ trans('pagination.next') }}</a>
                            </li>
                        @else
                            <li class="page-item disabled" aria-disabled="true">
                        ...
                        @if ($paginator->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" id="{!! $paginator->lastPage() !!}"
                                    href="{{ $paginator->toArray()['last_page_url'] }}">{{ trans('pagination.last') }}</a>
                            </li>
                        @else
                            <li class="page-item disabled" aria-disabled="true">
