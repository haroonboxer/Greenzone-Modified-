<!DOCTYPE html>
<html direction="{{ get_locale() == 'en' ? 'ltr' : 'rtl' }}" dir="{{ get_locale() == 'en' ? 'ltr' : 'rtl' }}"
    style="direction: {{ get_locale() == 'en' ? 'ltr' : 'rtl' }}">
<!--begin::Head-->

<head>
    <meta charset="utf-8" />
    <title>{{ trans('words.MOI') }}</title>
    <meta name="description" content="Area Control Unit ACU" />
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />
    <link href="{{ asset('assets/plugins/custom/fullcalendar/fullcalendar.bundle.rtl.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('assets/datePicker/css/persianDatepicker-default.css') }}" rel="stylesheet" />
    ...
    <link href="{{ asset('assets/css/custome_style.css') }}" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed page-loading">
    <!--begin::Main-->
    @include('layouts.partial._loader_base')
    <!--begin::Header Mobile-->
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="d-flex flex-row flex-column-fluid page">
            ...
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                ...
                <div class="content d-flex flex-column flex-column-fluid " id="kt_content">
                    ...
                    <div class="d-flex flex-column-fluid">
                        <!--begin::Container-->
                        <div class="container-fluid" id="response_div">
                            @yield('content')
                        </div>
                        <!--end::Container-->
                    </div>
            ...
            <div class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel"
                aria-hidden="true" tabindex="-1" id="mediumModalAtt">
    ...
    <!--end::Main-->
    <!-- begin::User Panel-->
    @include('layouts.partial.__user_profile_panel')
    <!-- end::User Panel-->
    <!--begin::Scrolltop-->
    @include('layouts.partial.__scrlltop')
    <!--end::Scrolltop-->
    <script>
        var KTAppSettings = {
            "breakpoints": {
    ...
    <script src="{{ asset('assets/datePicker/js/vertical-responsive-menu.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/datePicker/js/prism.js') }}"></script>
    <script src="{{ asset('assets/datePicker/js/persianDatepicker.js') }}"></script>
