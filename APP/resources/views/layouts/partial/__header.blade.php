<div id="kt_header" class="header header-fixed">
    <!--begin::Container-->
    <div class="container-fluid d-flex align-items-stretch justify-content-between" style="background-color: #153a81">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm"
                            src="{{ get_locale() == 'en' ? asset('icons/us-flag.svg') : asset('icons/emirate-flag.png') }}"
                            alt="" /> &nbsp;
                        <p class="mt-4 ">
                            {{ get_locale() == 'da' ? trans('global.dari') : trans('global.pashto') }}
                        </p>
