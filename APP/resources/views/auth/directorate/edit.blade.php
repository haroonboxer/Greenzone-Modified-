<div class="modal-header bg-color-dark">
    <h3>
        <span class="profile-main-title white-color"><i
                class="m-menu__link-icon fas fa-sitemap text-primary"></i>&nbsp;&nbsp;{{ trans('zone.editGozar') }}</span>
    </h3>
        ...
        <div class="col-lg-12">
            <form enctype="multipart/form-data" id="requestForm" method="post">
                ...
                <div class="row">
                    <div class=" col-lg-4">
                        ...
                        <div id="name" class="errorDiv">
                            <input class="form-control m-input errorDiv" type="text" value="{{$directorate->name_da}}" name="name_da"
                    ...
                    <div class=" col-lg-4">
                        ...
                        <div id="name_pa" class="errorDiv">
                            <input class="form-control m-input errorDiv" type="text" value="{{$directorate->name_pa}}" name="name_pa"
                    ...
                    <div class=" col-lg-4">
                        ...
                        <div id="name_en" class="errorDiv">
                            <input class="form-control m-input errorDiv" type="text" value="{{$directorate->name_en}}" name="name_en"
                    ...
                    <div class=" col-lg-12">
                        ...
                        <div id="code" class="errorDiv">
                            <input class="form-control m-input errorDiv" type="text" value="{{$directorate->code}}" name="code"
                ...
                <div class="row p-5 mt-3" style="background-color: #fafafa">
                    <div class="col-lg-12">
                        <button type="button"
                            onclick="server_request_for_storing_record('{{ route('update-directorate', $id) }}','requestForm','POST','response_div','submitBtn');"
