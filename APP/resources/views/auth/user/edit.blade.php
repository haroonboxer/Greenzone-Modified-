            ...
            <div class="col-lg-12">
                <form enctype="multipart/form-data" id="requestForm" method="post" autocomplete="off">
                                ...
                                <div class="row pl-3 mt-2">
                                        ...
                                        <select class="form-control select2" name="directorate" id="directorate"
                                            ...
                                            @foreach ($directorates as $direct)
                                                <option value="{{ $direct->id }}"
                                                    {{ $direct->id == $record->directorate_id ? 'selected' : '' }}>
                                                    {{ $direct->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-lg-4">
                                        ...
                                        <select class="form-control select2" name="department" id="department_response"
                                            ...
                                            @foreach ($departments as $dep)
                                                <option value="{{ $dep->id }}"
                                                    {{ $dep->id == $record->department_id ? 'selected' : '' }}>
                                                    {{ $dep->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-lg-4">
                                        ...
                                        <select class="form-control select2" name="departmentSub" id="departmentSub">
                                            ...
                                            @foreach ($departmentSub as $subDep)
                                                <option value="{{ $subDep->id }}"
                                                    {{ $subDep->id == $record->sub_department_id ? 'selected' : '' }}>
                                                    {{ $subDep->name }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-lg-4">
                                        ...
                                        <select class="form-control select2" name="province" id="province">
                                            ...
                                            @foreach ($provinces as $pro)
                                                <option value="{{ $pro->id }}"
                                                    {{ $pro->id == $record->location_id ? 'selected' : '' }}>
                                                    {{ $pro->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-lg-4">
                                        ...
                                        <select class="form-control select2" name="system_id[]" id="system_id"
                                            ...
                                            @foreach ($systems as $sys)
                                                <option value="{{ $sys->id }}"
                                                    {{ in_array($sys->id, $userSystem) ? 'selected' : '' }}>
                                                    {{ $sys->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class=" col-lg-4">
                                        ...
                                        <div id="section_result">
                                            <select class="form-control select2" name="status" id="status">
                                                ...
                                                <option value="active"
                                                    {{ $record->status == 'active' ? 'selected' : '' }}>
                                                    {{ trans('global.active') }}
                                                </option>
                                                <option value="inactive"
                                                    {{ $record->status == 'inactive' ? 'selected' : '' }}>
                                ...
                                <div class="row col-lg-12">
                                    <div class="col-lg-6">
                                        ...
                                        <label style="cursorLpointer">
                                            ...
                                            <img src="{{ asset($record->image ? 'storage/' . $record->image : 'img/user_male.png') }}"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <label style="cursorLpointer">
                                            ...
                                            <img src="{{ asset($record->signature ? 'storage/' . $record->signature : 'img/finger.png') }}"
                    ...
                    <div class="row p-5 mt-3" style="background-color: #fafafa">
                        <div class="col-lg-12">
                            <button type="button"
                                onclick="save_record('{{ route('update-user', $record->id) }}','requestForm','POST','response_div','submitBtn');"
