        ...
        <div class="card-header container-fluid p-4">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title mt-3"> <i class="fas fa-sitemap text-primary"></i>&nbsp;
                    <b>{{ trans('global.departmentSubList') }}</b>
                </h5>
                <div>
                    <a href="javascript:void()"
                        onclick="javascript: show_modal_by_ajax('{{ route('create-sub-department') }}','ajax_modal');"
                ...
                <div class="m-portlet__body table-responsive">
                    <form id="search_form" autocomplete="off">
                        <div class="row d-flex p-3" style="background-color: #f5f5f5">
                            <div class="col-lg-3">
                                <label class="title-custom">{{ trans('zone.gozarName') }}:</label>
                                <input type='search' class='form-control keypressbutton' style='' name='search_name'
                                    id="search_name" placeholder="{{ trans('zone.gozarName') }}" />
                            </div>
                        </div>
