<div class="modal-header bg-color-dark">
    <h3>
        <span class="profile-main-title white-color"><i
                class="m-menu__link-icon fas fa-sitemap text-primary"></i>&nbsp;&nbsp;{{ trans('global.departmentCreate') }}</span>
    </h3>
        ...
        <div class="col-lg-12">
            <form enctype="multipart/form-data" id="requestForm" method="post">
                ...
                <div class="row p-5 mt-3" style="background-color: #fafafa">
                    <div class="col-lg-12">
                        <button type="button"
                            onclick="server_request_for_storing_record('{{ route('store-department') }}','requestForm','POST','response_div','submitBtn');"
