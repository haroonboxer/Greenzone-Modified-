...
const ViewUserForm = ({t, userData, changeUserStatus, id}: any) => {
            ...
            >
              <>
                <Dropdown.Item as='button'>
                  <span className='fw-bolder me-2' onClick={changeUserStatus}>
                    {status === 1 ? (
                      <>
                        <i className='fa-solid fa-user-slash text-primary'></i>
                        {t('global.deactive')}
                      </>
                    ) : (
                      <>
                ...
                <Dropdown.Item as='button'>
                  <span className='fw-bolder me-2' onClick={openModal}>
                ...
                <Dropdown.Item as='button'>
                  <Link className='fw-bold' to='/authentication/users'>
                    <span className='text-danger'>
                      <i className='fa-solid fa-reply-all  text-danger me-2'></i>
                      {'global.back'}
                    </span>
                  </Link>
                </Dropdown.Item>
        ...
        <div className='card-body'>
          ...
          <div className='row background-fa'>
            ...
            <div className='col-lg-3 col-md-4 col-sm-12 mb-2'>
              ...
              <div className='fs-4 m-0 p-0'>{userData.record.departmentName}</div>
            </div>
            ...
            <div className='col-lg-3 col-md-4 col-sm-12 mb-2'>
              ...
              <div className='fs-4 m-0 p-0'>{userData.record.provinceName}</div>
            </div>
          </div>
          ...
          <div className='row background-fa'>
            ...
            <div className='col-lg-6 col-md-6 col-sm-6'>
              ...
              <img
                src={
                  userData.record.signature !== ''
                    ? process.env.REACT_APP_API_URL + 'storage/' + userData.record.signature
                    : userImage
                }
                className='img-fluid img-thumbnail image-view h-200px'
                alt='user-profile'
