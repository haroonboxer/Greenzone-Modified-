              ...
              <div className='col-lg-3 col-md-4 col-sm-12 mb-2'>
                ...
                <CustomeSelect
                  ...
                  onChange={(location: any) => {
                    formik.setFieldValue('location_id', location.value)
                  }}
                  options={provinces}
                  placeholder={t('global.select', {name: t('global.province')})}
                  className={renderErrorMessage('location_id') ? `validation-error-select` : ''}
                />
                {renderErrorMessage('location_id')}
              </div>
              ...
              <div className='col-lg-3 col-md-4 col-sm-12 mb-2'>
                ...
                <CustomeSelect
                  ...
                  onChange={(department: any) => {
                    formik.setFieldValue('department_id', department.value)
                  }}
                  options={departmentsOptions}
                  placeholder={t('global.select', {name: t('user.department')})}
                  className={renderErrorMessage('department_id') ? `validation-error-select` : ''}
                />
            ...
            <div className='row background-fa'>
              ...
              <div className='col-lg-6 col-md-6 col-sm-6'>
                ...
                <label>
                  ...
                  <img
                    src={
                      signaturePreviews.length > 0 && SignatureFileTypes[0] === 'signature'
                        ? signaturePreviews[0]
                        : userImage
                    }
                    className='img-fluid img-thumbnail image-view h-200px'
