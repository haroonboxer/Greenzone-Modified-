    ...
    <div className='card' id='kt_profile_details_view'>
      <div className='card-header cursor-pointer'>
        <div className='card-title m-0'>
          <h3 className='fw-bolder m-0'>{t('user.addNewRole')}</h3>
        </div>
      </div>
      <div className='card-body p-0 m-0'>
        ...
        >
          <div className='card-body'>
            ...
            <div className='row background-fa'>
              <div className='col-lg-4 col-md-4 col-sm-12'>
                ...
                <input
                  ...
                  className={`form-control form-control-sm ${renderErrorMessage('name') ? 'is-invalid' : ''
                    }`}
                />
              ...
              <div className='col-lg-4 col-md-4 col-sm-12 mb-2'>
                ...
                <CustomeSelect
                  ...
                  className={renderErrorMessage('system_id') ? 'is-invalid' : ''}
                />
                {renderErrorMessage('system_id')}
              </div>
            </div>

            <div className='row background-fa mt-4'>
                  ...
                  <label className='col-form-label label fw-bold fs-5'>
                    ...
                    <input
                      ...
                      checked={
                        ...
                        selectedCheckboxes.length === permissions.length
                      }
                      disabled={!formik.values.system_id}
                    />
                  </label>
                  <br />
                  <div className='row'>
                    {permissions.map((p: any) => (
                      <div
                        className='form-check form-check-inline col-lg-3 col-md-3 col-sm-6 mb-2'
                        key={p.id}
                      >
            ...
            <div className='row background-f5 mt-4'>
